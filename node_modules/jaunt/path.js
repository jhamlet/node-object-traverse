...
PathCursor = Cursor.extend({
    constructor: function PathCursor (list) {
        this.constructor.superclass.call(this, list);
    },
    
    get root () {
        return this.list.subject.subject;
    },
...
Path = LinkedList.extend({
    constructor: function Path (jaunt, init) {
        this.subject = this.jaunt = jaunt;
        this.constructor.superclass.apply(this, init || []);
    },
    
    getCursor: function () {
        var cursor = new PathCursor(this);
        return cursor.ffwd();
    }
});
//---------------------------------------------------------------------------
