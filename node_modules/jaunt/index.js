...
// Jaunt Factory
//---------------------------------------------------------------------------
Jaunt = utils.inherit(EventEmitter, {
    /**
     ...
     * @returns {Object}
     */
    constructor: function Jaunt (opts, obj) {
        var path = new Path(this),
            childKeys;

        opts = opts || {};

        Jaunt.superclass.call(this);
        ...
        this.path    = path;
        this.visited = new utils.LinkedList();
        this.visit   = new utils.LinkedList();
    },
    ...
    walk: function (obj) {
        ...
        if (!obj) {
            throw new Error('Jaunt#walk() needs something to traverse.');
        }
     ...
     * @event Jaunt#enter
     * @type {Jaunt.PathCursor} The cursor for path node access
     * @type {Jaunt} The current Jaunt instance
     * 
     ...
     * @type {Jaunt} The current Jaunt instance
     * 
     * If the Jaunt instance is configured with a `typeKey` will fire an
     * event of `[enter|leave]:[nodeType]` when entering or leaving a node.
     * @event Jaunt#[enter|leave]:[nodeType]
     * @type {Jaunt.PathCursor} The cursor for node
     * @type {Jaunt} The current Jaunt instance
     */
     ...
     * @fires Jaunt#leave
     * @fires Jaunt#*
     * @fires Jaunt#[enter|leave]:[nodeType]
     * @param {String} name Name of the event
     * @returns {Jaunt} The current instance
     */
    emit: function (name) {
